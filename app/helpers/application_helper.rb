module ApplicationHelper
  def render_manuscript_thumbnail document, image_options = {}
    ...
    if manuscript_number and PARKER_MASTER.has_key?(manuscript_number)
      ...
      thumbnail = image_tag get_preview_image(document, druid, image_options[:size]), :alt => 'Manuscript preview', :class => 'thumbImg', :title => get_preview_image(document, druid, image_options[:size])
    end
  ...
  def render_iiif_manifest document
    ...
    # check if manuscript belongs to e-codices collection and get thumbnail
    elsif document.first('collection_display').to_s == 'Swiss Medieval Manuscripts'
